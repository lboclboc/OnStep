...
#undef HAL_SERIAL_B_ENABLED       // Enable support for RX1/TX1
#undef HAL_SERIAL_C_ENABLED
#undef HAL_SERIAL_C_SERIAL2     // Use RX2/TX2 for channel C (defaults to RX3/TX3 otherwise.)
